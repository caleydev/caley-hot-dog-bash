    ...
    return (
      <PublicLayout>
        <div className="mx-auto max-w-md glass rounded-3xl p-8 text-center space-y-4">
          <h2 className="text-xl font-bold">No encontramos tu registro</h2>
          <p className="text-sm text-muted-foreground">El enlace puede haber expirado.</p>
    ...
    <PublicLayout>
      ...
      >
        ...
        <div className="rounded-2xl gradient-warm p-4 text-white text-sm flex items-center gap-3">
          ...
          <span className="text-left">Ahora puedes entrar al <strong>giveaway especial</strong> del evento.</span>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            Participar en el Giveaway
          </Button>
          <Button variant="ghost" onClick={() => setDeclined(true)}>No por ahora</Button>
        </div>
      </motion.div>
    </PublicLayout>
  );
